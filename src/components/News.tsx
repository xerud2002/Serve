          ...
          <div className="mb-16">
            <article className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                {/* Image Placeholder */}
                <div className="bg-gradient-to-br from-serve-blue-100 to-serve-blue-200 h-64 lg:h-full flex items-center justify-center">
                  <div className="text-center text-serve-blue-600">
                    <TrophyIcon className="w-24 h-24 mx-auto mb-4" />
                    <p className="text-lg font-semibold">Award Winner</p>
                    <p className="text-sm">Great British Care Awards 2024</p>
                  </div>
                </div>
              </div>
            </article>
