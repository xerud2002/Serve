            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <div className={`flex items-center ${isMobile ? 'space-x-2' : 'space-x-2'} mt-0.5`}>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`group relative ${isMobile ? 'p-1.5' : 'p-1.5'} rounded-lg bg-gradient-to-br from-serve-red-500 to-serve-red-600 hover:from-serve-red-600 hover:to-serve-red-700 shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300 ${MOBILE_CLASSES.touchTarget} ${FOCUS_STYLES.link}`}
