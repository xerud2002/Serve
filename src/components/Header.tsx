            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <div className={`flex items-center ${isMobile ? 'space-x-2' : 'space-x-2'} mt-0.5`}>
                ...
                <a
                  ...
                  className={`group relative ${isMobile ? 'p-1.5' : 'p-1.5'} rounded-lg bg-gradient-to-br from-serve-blue-500 to-serve-blue-600 hover:from-serve-blue-600 hover:to-serve-blue-700 shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300 ${MOBILE_CLASSES.touchTarget} ${FOCUS_STYLES.link}`}
                  aria-label={ARIA_LABELS.facebook}
                >
                  <svg className={`${isMobile ? 'h-4 w-4' : 'h-4 w-4'} text-white`} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`group relative ${isMobile ? 'p-1.5' : 'p-1.5'} rounded-lg bg-white hover:bg-gray-50 shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300 ${MOBILE_CLASSES.touchTarget} ${FOCUS_STYLES.link}`}
                  aria-label={ARIA_LABELS.linkedin}
                >
                  <svg className={`${isMobile ? 'h-4 w-4' : 'h-4 w-4'} text-blue-600`} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
