            ...
            <div className="flex justify-between items-center py-2">
              ...
              <div className="flex items-center gap-2 sm:gap-6">
                <a 
                  ...
                  onClick={() => analytics.trackPhoneClick('01933315555', 'header')}
                >
              ...
              <div className="flex items-center gap-2">
                <a
                  ...
                  onClick={() => analytics.trackExternalLink('Facebook', 'https://www.facebook.com/SERVE234/')}
                >
                ...
                <a
                  ...
                  onClick={() => analytics.trackExternalLink('LinkedIn', 'https://www.linkedin.com/company/serve-nvca/')}
                >
                  <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
