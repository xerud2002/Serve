    ...
    <section className="py-24 bg-gradient-to-br from-slate-50 via-white to-slate-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center bg-gradient-to-r from-amber-100 to-yellow-50 text-amber-800 px-5 py-2.5 rounded-full text-sm font-semibold mb-6 shadow-sm">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            <span className="bg-gradient-to-r from-serve-blue-600 to-cyan-500 bg-clip-text text-transparent">Why Choose</span>{' '}
            <span className="bg-gradient-to-r from-rose-500 to-red-600 bg-clip-text text-transparent">SERVE?</span>
          </h2>
          ...
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-sm`} />
                ...
                <div className="relative bg-white rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 group-hover:-translate-y-1 h-full">
                  ...
                  <div className="relative">
                    <div className={`inline-flex items-center justify-center w-14 h-14 rounded-2xl mb-4 bg-gradient-to-br ${feature.bgGradient} shadow-sm group-hover:scale-110 transition-transform duration-300`}>
                      <IconComponent className={`w-7 h-7 bg-gradient-to-br ${feature.gradient} bg-clip-text`} style={{ color: 'transparent', background: `linear-gradient(to bottom right, var(--tw-gradient-stops))`, backgroundClip: 'text', WebkitBackgroundClip: 'text' }} />
                    ...
                    {feature.subtitle && (
                      <p className={`text-sm font-semibold mb-3 bg-gradient-to-r ${feature.gradient} bg-clip-text text-transparent`}>{feature.subtitle}</p>
                    )}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          {/* Our Story */}
          <div>
            <div className="inline-flex items-center bg-gradient-to-r from-serve-blue-100 to-cyan-50 text-serve-blue-800 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            <h3 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
              <span className="bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Four Decades of </span>
              <span className="bg-gradient-to-r from-serve-blue-600 to-cyan-500 bg-clip-text text-transparent">Compassionate Care</span>
            </h3>
            ...
            <div className="mt-8">
              <a 
                ...
                className="inline-flex items-center bg-gradient-to-r from-serve-blue-600 to-cyan-600 text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group"
              >
          ...
          <div className="relative">
            <div className="relative h-full min-h-[400px] lg:min-h-[550px] rounded-3xl overflow-hidden shadow-2xl">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-serve-blue-900/40 via-transparent to-transparent" />
            </div>
