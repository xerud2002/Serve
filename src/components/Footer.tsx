            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="group bg-gray-800 hover:bg-blue-600 p-3 rounded-xl transition-all duration-300 transform hover:scale-110"
                  aria-label="Follow SERVE on Facebook"
                >
                  <svg className="h-6 w-6 text-gray-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group bg-gray-800 hover:bg-blue-700 p-3 rounded-xl transition-all duration-300 transform hover:scale-110"
                  aria-label="Connect with SERVE on LinkedIn"
                >
                  <svg className="h-6 w-6 text-gray-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
