...
export default function VolunteerForm() {
  ...
  return (
    <section id="volunteer-form" className="py-20 bg-linear-to-br from-slate-50 via-white to-green-50 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-12">
          <div className="inline-flex items-center bg-linear-to-r from-serve-green-100 to-emerald-50 text-serve-green-800 px-5 py-2.5 rounded-full text-sm font-bold mb-6 shadow-sm border border-serve-green-200">
            📝 Application Form
          </div>
        ...
        <div className="relative">
          <div className="absolute -inset-1 bg-linear-to-r from-serve-green-500 via-emerald-500 to-serve-green-500 rounded-3xl blur-xl opacity-20" />
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday', 'Flexible'].map((day) => (
                      <label key={day} className="flex items-center bg-gray-50 hover:bg-serve-green-50 border-2 border-gray-200 hover:border-serve-green-300 rounded-xl px-4 py-3 cursor-pointer transition-all duration-200 shadow-sm hover:shadow">
                        <input
                          type="checkbox"
                          name="availability"
                          value={day}
                        ...
                        />
                        <span className="ml-3 text-sm font-semibold text-gray-700">{day}</span>
                      </label>
                    ))}
                  </div>
                </div>
              ...
              <div className="pt-6">
                <button
                  ...
                  className="w-full bg-linear-to-r from-serve-green-600 to-emerald-600 hover:from-serve-green-700 hover:to-emerald-700 disabled:from-gray-400 disabled:to-gray-500 disabled:cursor-not-allowed text-white px-8 py-5 rounded-2xl text-lg font-bold transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl"
                >
                  {isSubmitting ? (
