...
export const seoConfigs = {
  home: {
    title: 'SERVE | Award-Winning Care in Northamptonshire',
    description: 'Award-winning care for older people and adults with disabilities. Best Homecare Team 2024. Call 01933 315555.',
  ...
  services: {
    title: 'Care Services | SERVE Northamptonshire',
    description: 'Personal care, day care, transport and befriending. CQC registered, award-winning. Free assessment: 01933 315555.',
  ...
  about: {
    title: 'About Us | SERVE Charity Northamptonshire',
    description: '40+ years supporting older people and adults with disabilities. Award-winning team. Learn more about our mission.',
  ...
  contact: {
    title: 'Contact | SERVE Care Services',
    description: 'Call 01933 315555, email info@serve.org.uk, or visit 8 West Street, Rushden, NN10 0RT. We\'re here to help.',
  ...
  volunteer: {
    title: 'Volunteer | SERVE Charity',
    description: 'Make a difference in Northamptonshire. Volunteer in befriending, events, admin, and fundraising. Call 01933 315555.',
  ...
  news: {
    title: 'News & Events | SERVE Charity',
    description: 'Latest news, award wins and upcoming events from SERVE. See how we\'re making a difference in Northamptonshire.',
  ...
  donate: {
    title: 'Donate | Support SERVE Charity',
    description: 'Your donation transforms lives. Support care services for vulnerable adults in Northamptonshire. Donate via JustGiving.',
